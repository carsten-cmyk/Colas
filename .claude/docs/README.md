...
**Projekt:** Colas Transport Apps Monorepo
**Oprettet:** 2026-02-11
**Baseret på:** Enterprise Strategy Platform v2.0 documentation + colas_app best practices

## Apps i Monorepo
- **Chauffeur App** - App til chauffører (React Native/Expo)
- **Vognmand App** - App til vognmænd (kommer snart)
- **Formand App** - App til formænd (kommer snart)
